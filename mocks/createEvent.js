function getCreateEventRepository(TEST_USERNAME) {
  return {
    id: "41940530845",
    type: "CreateEvent",
    actor: {
...
function getCreateEventBranch(TEST_USERNAME) {
  return {
    id: "41941838480",
    type: "CreateEvent",
    actor: {
    ...
    public: true,
    created_at: "2024-09-15T14:19:09Z",
  }
}

module.exports = { getCreateEventRepository, getCreateEventBranch }
